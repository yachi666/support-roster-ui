  ...
  >
    ...
    <div class="flex items-center space-x-4">
      ...
      <div class="relative group">
        <div
          class="flex items-center space-x-2 bg-white border border-gray-200 rounded-lg px-3 py-1.5 hover:border-gray-300 transition-colors shadow-sm"
        >
      ...
      <div class="ml-2 flex items-center gap-2">
        ...
        <RouterLink
          ...
          class="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-amber-200 bg-amber-50 text-amber-700 shadow-sm transition-colors hover:border-amber-300 hover:bg-amber-100 hover:text-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-200 focus:ring-offset-2"
        >
