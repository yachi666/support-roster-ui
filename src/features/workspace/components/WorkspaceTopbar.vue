...
import { CalendarDays, ChevronLeft, ChevronRight, ContactRound, Globe, KeyRound, Search } from 'lucide-vue-next'
...
const topbarShellClass = 'flex h-16 w-full min-w-0 flex-1 items-center gap-2'
const topbarSearchShellClass = 'group relative w-[9.5rem] shrink min-[1280px]:w-[11rem] min-[1536px]:w-[12rem]'
const topbarSearchInputClass = 'h-9 w-full rounded-lg border border-slate-200 bg-white py-2 pl-9 pr-2 text-sm text-slate-700 shadow-sm outline-none transition-all placeholder:text-slate-400 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/15'
const topbarPeriodShellClass = 'flex h-9 w-fit shrink-0 items-center justify-center gap-0.5 rounded-xl border border-slate-200 bg-white px-1 shadow-sm'
const topbarMonthSelectClass = 'h-7 w-[4.75rem] rounded-lg border border-transparent bg-slate-50 pl-2 pr-6 text-sm font-semibold text-slate-900 outline-none transition-colors hover:border-slate-200 focus:border-teal-300 focus:bg-white focus:ring-2 focus:ring-teal-500/15'
const topbarYearSelectClass = 'h-7 w-[4.35rem] rounded-lg border border-transparent bg-slate-50 pl-1.5 pr-5 text-sm font-semibold text-slate-900 outline-none transition-colors hover:border-slate-200 focus:border-teal-300 focus:bg-white focus:ring-2 focus:ring-teal-500/15'
const topbarMetaControlClass = 'flex h-7 min-w-0 items-center gap-1 rounded-lg border border-slate-200 bg-slate-50 pl-1.5 pr-1'
    ...
    <div :class="topbarShellClass">
      ...
      <div :class="topbarPeriodShellClass">
        <button
          ...
          class="shrink-0 rounded-lg border border-transparent bg-white p-1.5 text-slate-500 transition-colors hover:border-slate-200 hover:text-slate-800"
        ...
        <div :class="topbarMetaControlClass">
          ...
          <select
            ...
            :value="timezone"
            class="w-[2.75rem] appearance-none bg-transparent pr-0 text-sm font-medium text-slate-700 outline-none"
        ...
        <div :class="topbarMetaControlClass">
          <select
            ...
            :value="currentLocale"
            class="w-[4rem] appearance-none bg-transparent pr-0 text-sm font-medium text-slate-700 outline-none"
      ...
      <div :class="topbarActionClusterClass">
        ...
        >
          <CalendarDays class="h-4 w-4 text-teal-600" />
          <span>{{ t('workspace.shell.openViewer') }}</span>
        </RouterLink>
      </div>
    </div>
  </header>
