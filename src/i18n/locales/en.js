export default {
  ...
  productUpdates: {
    ...
    aiMaintained: 'AI maintained with PRs',
    timelineLabel: 'Version timeline',
    detailLabel: 'Version details',
    releaseDate: 'Release date',
    impactLabel: 'Update impact',
    impactTitle: 'Impact',
    highlightsLabel: 'Highlights',
    sourcePrs: 'Related PRs',
    changesLabel: 'Changes',
    emptyList: 'No product updates found',
  ...
  linuxPasswords: {
    ...
    searchPlaceholder: 'Search host or IP...',
    columns: {
      hostname: 'Hostname',
    ...
    emptyState: 'No servers found. Try a different search or add a new machine.',
    showingServers: 'Showing {count} servers',
    systemActive: 'System active',
    winscp: 'WinSCP',
    copied: 'Copied to clipboard',
    copiedServer: 'Copied password for {hostname} / {username}.',
    ...
    formDescription:
      'Enter network and credential details to add a new Linux host to this demo vault.',
    hostnamePlaceholder: 'e.g. prod-web-01',
    ...
    loginAccountsHint:
      'Maintain multiple Linux login accounts on one machine. Viewing or copying a password writes an audit record.',
    addCredential: 'Add account',
    removeCredential: 'Remove account',
    noCredentials: 'No login accounts yet',
    credentialNotesPlaceholder: 'e.g. usage, privilege scope, or handoff note',
    assignFolders: 'Assign to folders (modules)',
    assignFoldersHint: 'Choose one or more folders to organize this machine.',
    newDirectoryLabel: 'New directory',
    newDirectoryPlaceholder: 'Type one new directory name',
    newDirectoryHint:
    ...
    revealFailed: 'Failed to reveal the password.',
    audit: {
      sidebarEntry: 'Audit Records',
      ...
      filters: {
        ...
        keywordPlaceholder: 'Staff, machine, account, source IP...',
        staffId: 'Staff ID',
  ...
  workspace: {
    ...
    overview: {
      ...
      moduleFilterLabel: 'Filter recent operations by module',
      context: {
        month: 'Month',
        timezone: 'Timezone',
      ...
      continue: {
        roster: 'View and edit the roster grid for the selected month.',
        importExport: 'Import roster data or export current results.',
        validation: 'Review validation issues and data problems.',
        staff: 'Browse and manage staff records.',
      },
      modules: {
        all: 'All modules',
        workspace: 'Workspace',
    ...
    roster: {
      ...
      assignmentDrawer: {
        ...
        rangeFollowsSelection: 'Apply Change now follows the dragged selection directly.',
