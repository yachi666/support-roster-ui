export default {
  ...
  linuxPasswords: {
    ...
    formDescription: 'Enter network and credential details to add a new Linux host to this demo vault.',
    ...
    newDirectoryHint: 'If the directory does not exist yet, enter it here and save it with the form.',
